window.onload=function(){
    ...
    document.getElementById("filtrare").onclick=function(){
        ...
        for (let prod of produse){
            ...
            let nume= prod.getElementsByClassName("val-name")[0].innerHTML.trim().toLowerCase()
    ...
    function sorteaza(semn){
        ...
        vProduse.sort(function(a,b){
            ...
            if(pretA==pretB){
                let numeA=a.getElementsByClassName("val-name")[0].innerHTML.trim().toLowerCase();
                let numeB=b.getElementsByClassName("val-name")[0].innerHTML.trim().toLowerCase();
    ...
    window.onkeydown=function(e){
        if(e.key=="c" && e.altKey){
            ...
            let p = this.document.getElementById("SumaProduseAfisate")
            if(!p){
